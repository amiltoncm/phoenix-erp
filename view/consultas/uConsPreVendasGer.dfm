inherited frmConsPreVendasGer: TfrmConsPreVendasGer
  ...
  object cbStatus: TwwDBLookupCombo
    ...
    DropDownAlignment = taLeftJustify
    Selected.Strings = (
      'sto_descricao'#9'20'#9'Status'#9'F'#9)
    LookupTable = dmLookups.qyLkStatusOrc
    LookupField = 'sto_descricao'
    Options = [loColLines, loRowLines, loTitles]
    TabOrder = 3
    AutoDropDown = True
    ShowButton = True
