inherited frmRelPreVendaEfet: TfrmRelPreVendaEfet
  Caption = 'Imprimir Pr'#233'-venda (Efetivada)'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Relatorio: TppReport
    PrinterSetup.DocumentName = 'DAV - Pr'#233'-venda (Efetivada)'
    CachePages = True
    ...
    inherited ppHeaderBand1: TppHeaderBand
      ...
      inherited ppLinha2: TppLine [15]
        mmHeight = 265
        mmTop = 18785
        LayerName = Foreground
      end
      inherited ppLinha1: TppLine [16]
        LayerName = Foreground
      end
    end
