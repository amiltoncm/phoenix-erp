inherited frmRelCaixaDet: TfrmRelCaixaDet
  Caption = 'Relat'#243'rio do Caixa (Detalhado)'
  ClientHeight = 117
  ClientWidth = 456
  ExplicitWidth = 462
  ExplicitHeight = 146
  ...
  inherited Relatorio: TppReport
    PrinterSetup.DocumentName = 'Relat'#243'rio de Caixa (Detalhado)'
  ...
  inherited dsDados: TDataSource
    DataSet = dmConsultas.qyRelCaixaDet
    Left = 320
    Top = 0
  end
end
