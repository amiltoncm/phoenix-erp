inherited frmConfBxReceber: TfrmConfBxReceber
  Caption = 'Confirmar baixa de parcela'
  ClientHeight = 420
  ClientWidth = 594
  ExplicitWidth = 600
  ExplicitHeight = 449
  ...
  object cbConta: TwwDBLookupCombo [8]
    ...
    Width = 181
    Height = 21
    Hint = 'Conta onde erntrar'#225' o dinheiro'
  ...
  object cbPlanoContas: TwwDBLookupCombo [10]
    ...
    LookupTable = dmLookups.qyLkPlanoContasEnt
